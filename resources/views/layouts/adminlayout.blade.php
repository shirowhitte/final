...
<body>
    ...
    <section id="topbar" class="d-flex align-items-center fixed-top topbar-RED">
        <div class="container-fluid container-xxl d-flex align-items-center justify-content-center h5 p-2"
            style="margin:auto;">
            @guest
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <a style="color:black;" class="dropdown-item"
                                        ...
                                        <a style="color:black;" class="dropdown-item" href="{{ route('admin.show') }}">{{ __('Reservation') }}</a>
                                       <a style="color:black;" class="dropdown-item" href=" {{ url('admin') }}">{{ __('Report') }}</a>
                                    <a style="color:orange;" class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
